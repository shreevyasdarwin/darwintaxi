...
class Refresh_Token 
{
    ...
    public function __construct()
    {
         ...
         */
        $this->token_key            = $this->CI->config->item('jwt_key_ref');
        $this->token_algorithm      = $this->CI->config->item('jwt_algorithm_ref');
        $this->token_header         = $this->CI->config->item('token_header_ref');
        $this->token_expire_time    = $this->CI->config->item('token_expire_time_ref');
    }
